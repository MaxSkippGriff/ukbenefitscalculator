...
GUIDES: Dict[str, Dict] = {
    ...
    "auto-enrolment-pension-costs": {
        "title": "Auto-enrolment pension costs for employers explained",
        "description": "How employer pension contributions are calculated and budgeted in UK payroll.",
        "topic": "Pensions",
        "sections": [
            {
...
GSC_INTENT_PAGES: Dict[str, Dict] = {
    ...
    "/auto-enrolment-payroll-costs": {
        "title": "Auto Enrolment Payroll Costs (2025/26) | EmployerCalculator.co.uk",
        "description": "Auto enrolment payroll costs page for UK employers. Understand minimum pension contribution cost and run contribution scenarios for 2025/26.",
        "h1": "Auto enrolment payroll costs for UK employers",
        "badge": "Pension intent",
        "intro": "This page targets auto enrolment payroll costs: the recurring pension contribution cost employers must fund for eligible workers. It uses the 2025/26 qualifying earnings band and links to the live pension and total-cost tools.",
        "bullets": [
            "Minimum employer contribution is 3% of qualifying earnings.",
            "Qualifying earnings are currently £6,240 to £50,270.",
            "Model pension-only scenarios first, then include NI and overheads.",
        ],
        "primary_cta": {"label": "Open auto-enrolment pension cost calculator", "url": "/pension-cost"},
        "faq_items": [
            {"q": "What are qualifying earnings for auto-enrolment?", "a": "For 2025/26, qualifying earnings for minimum contribution modelling are £6,240 to £50,270. Employer minimum is 3% of earnings within that band."},
            {"q": "Where do I calculate full employer cost with NI too?", "a": "Use the full employer calculator to combine salary, employer NI, pension and overheads in one result."},
        ],
    },
